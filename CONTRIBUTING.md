...
* Translations
    * README.md
    * [docs](https://github.com/kamruljpi/docs/issues/1)
* Bug-hunting
* Finding security problems
* Themes and Plugins

See [manual](https://github.com/kamruljpi/go-admin/projects/3) for more information.

You can view all open issues on github, which is usually a good starting point if you want to start contributing:

https://github.com/search?q=org%3Akamruljpi+is%3Aopen+is%3Aissue+archived%3Afalse&type=Issues
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/kamruljpi/go-admin clone, so:

```bash

$ go get github.com/kamruljpi/go-admin
$ cd $GOPATH/src/github.com/kamruljpi/go-admin # GOPATH is $HOME/go by default.
...
Notice: `go get` return `package github.com/kamruljpi/go-admin: no Go files in /go/src/github.com/kamruljpi/go-admin` is normal.
...
* [Tasks](https://github.com/kamruljpi/go-admin/projects)
