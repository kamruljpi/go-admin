...
import (
	...
	"github.com/kamruljpi/go-admin/modules/collection"
	"github.com/kamruljpi/go-admin/modules/config"
	"github.com/kamruljpi/go-admin/modules/db"
	"github.com/kamruljpi/go-admin/modules/db/dialect"
	errs "github.com/kamruljpi/go-admin/modules/errors"
	"github.com/kamruljpi/go-admin/modules/language"
	"github.com/kamruljpi/go-admin/modules/logger"
	"github.com/kamruljpi/go-admin/modules/ui"
	"github.com/kamruljpi/go-admin/modules/utils"
	"github.com/kamruljpi/go-admin/plugins/admin/models"
	...
	"github.com/kamruljpi/go-admin/plugins/admin/modules/tools"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/kamruljpi/go-admin/modules/db/dialect", Value: "github.com/kamruljpi/go-admin/modules/db/dialect"},
			{Text: "github.com/kamruljpi/go-admin/modules/db", Value: "github.com/kamruljpi/go-admin/modules/db"},
			{Text: "github.com/kamruljpi/go-admin/modules/language", Value: "github.com/kamruljpi/go-admin/modules/language"},
			{Text: "github.com/kamruljpi/go-admin/modules/logger", Value: "github.com/kamruljpi/go-admin/modules/logger"},
		}).
		FieldDefault("").
