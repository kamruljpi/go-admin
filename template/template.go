...
import (
	...
	errors2 "github.com/kamruljpi/go-admin/modules/errors"
	"github.com/kamruljpi/go-admin/modules/language"
	"github.com/kamruljpi/go-admin/modules/logger"
	"github.com/kamruljpi/go-admin/modules/menu"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/kamruljpi/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/kamruljpi/go-admin/blob/master/template/login/list.go
	GetAssetList() []string
